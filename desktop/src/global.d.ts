...
declare global {
  interface Window {
    electronAPI?: {
      ...
      setLaunchAtLogin: (enabled: boolean) => Promise<{ status: string; enabled?: boolean; message?: string }>;
      restoreCodexOfficial: () => Promise<{ status: string; message: string; backup_path?: string }>;
